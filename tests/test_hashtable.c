...
void test_insert_and_retrieve(void)
{
    ...
    for (int i = 0; i < 20; i++) {
        ...
        TEST_ASSERT_EQUAL_STRING(values[i], retrievedNode->item);
    }
...
void test_insert_collision(void)
{
    ...
    for (int i = 0; i < 5; i++) {
        ...
        TEST_ASSERT_EQUAL_STRING(values1[i], retrievedNode1->item);
        TEST_ASSERT_EQUAL_STRING(values2[i], retrievedNode2->item);
    }
